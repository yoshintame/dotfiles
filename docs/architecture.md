...
> **Target state:** этот документ описывает **текущее** состояние архитектуры и паттерны модулей. Целевое состояние (4 host'а, 3 wrapper'а, roadmap реализации) зафиксировано в [target-architecture.md](target-architecture.md).
