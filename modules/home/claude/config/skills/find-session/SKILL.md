...
Колонки: `score` = пиковая релевантность (лучшее сообщение сессии, нейтрально к длине), `total`/`hits` = плотность, `forks` = сколько клонов сессии (форки/резьюмы одной беседы) свёрнуто под этой строкой. Ранжирование по `score`.
